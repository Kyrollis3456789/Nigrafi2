...
export const ScriptureReader: React.FC<ScriptureReaderProps> = ({
  ...
  // Pre-compute bookmarks for the current chapter to avoid O(N) lookup per verse during render
