...
export const ScriptureReader: React.FC<ScriptureReaderProps> = ({
  ...
  // Pre-compute a Map of bookmarks for O(1) lookup during rendering
  // Prevents O(N*M) bottleneck where N = verses and M = bookmarks
  ...
  // ⚡ Bolt Performance Optimization:
  // Pre-compute a Set for highlights for O(1) lookup during rendering
